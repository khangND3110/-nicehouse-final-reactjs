...
const GlobalStyle = createGlobalStyle`
  * {
  ...
  ::selection {
    background: ${themeGet('primary.0', '#B38A4C')};
            ...
            &.account_menu {
              li {
                ...
                a {
                  ...
                  transition: color 0.2s ease-in-out;
                  &:hover {
                    color: ${themeGet('primary.0', '#B38A4C')};
                  }
                  &.active {
                    font-weight: 700;
                    color: ${themeGet('primary.0', '#B38A4C')};
  ...
  .quantity {
    button.btn {
      border: 1px solid ${themeGet('primary.0', '#B38A4C')};
      svg {
        fill: ${themeGet('primary.0', '#B38A4C')};
      }
      &:hover {
        background-color: ${themeGet('primary.0', '#B38A4C')};
        svg {
          fill: #ffffff;
        }
      }
      ...
      .main-menu {
        ...
        li {
          ...
          a {
            ...
            &.active {
              font-weight: 700;
              border-color: ${themeGet('primary.0', '#B38A4C')};
  ...
  .ant-checkbox-checked::after {
    border-color: ${themeGet('primary.0', '#B38A4C')} !important;
  }
